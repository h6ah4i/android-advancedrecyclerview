...
public class MyDraggableSwipeableSelectableItemAdapter
        ...
        implements DraggableItemAdapter<MyDraggableSwipeableSelectableItemAdapter.MyViewHolder>,
        SwipeableItemAdapter<MyDraggableSwipeableSelectableItemAdapter.MyViewHolder>,
        SelectableItemAdapter<MyDraggableSwipeableSelectableItemAdapter.MyViewHolder> {
    ...
    public static class MyViewHolder extends AbstractDraggableSwipeableSelectableItemViewHolder {
    ...
    public MyDraggableSwipeableSelectableItemAdapter(AbstractDataProvider dataProvider) {
