 ...
 */
class LegacySwipeableExampleAdapter
        extends RecyclerView.Adapter<LegacySwipeableExampleAdapter.MyViewHolder>
        implements LegacySwipeableItemAdapter<LegacySwipeableExampleAdapter.MyViewHolder> {
    ...
    public LegacySwipeableExampleAdapter(AbstractDataProvider dataProvider) {
