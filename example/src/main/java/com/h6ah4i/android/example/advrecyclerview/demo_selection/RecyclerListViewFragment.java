...
public class RecyclerListViewFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        //adapter
        final MySelectableItemAdapter myItemAdapter = new MySelectableItemAdapter(getDataProvider());
        myItemAdapter.setEventListener(new MySelectableItemAdapter.EventListener() {
            @Override
            public void onItemSelected(int position, boolean value) {
                ((SelectableExampleActivity) getActivity()).onItemSelected(position, value);
            }
        });

        mAdapter = myItemAdapter;

        mWrappedAdapter = mRecyclerViewSelectionManager.createWrappedAdapter(myItemAdapter);      // wrap for swiping
        ...
        SimpleListDividerDecorator simpleListDividerDecorator = new SimpleListDividerDecorator(getResources().getDrawable(R.drawable.list_divider), true);
        simpleListDividerDecorator.setzPositionThreshold(25f);
        mRecyclerView.addItemDecoration(simpleListDividerDecorator);
...
//        mRecyclerViewSwipeManager.setReturnToDefaultPositionAnimationDuration(2000);
    ...
    public AbstractDataProvider getDataProvider() {
        return ((SelectableExampleActivity) getActivity()).getDataProvider();
    }
