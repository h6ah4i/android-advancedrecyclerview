    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        myItemAdapter.setEventListener(new MyUnderSwipeableItemAdapter.EventListener() {
            ...
            public void onItemPinned(int position) {
                ((DoubleUnderSwipeableExampleActivity) getActivity()).onItemPinned(position);
            }
...
//        mRecyclerViewSwipeManager.setReturnToDefaultPositionAnimationDuration(2000);
    ...
    private void handleOnItemViewClicked(View v) {
        ...
        if (position != RecyclerView.NO_POSITION) {
            ((DoubleUnderSwipeableExampleActivity) getActivity()).onItemClicked(position);
        }
    }
    ...
    private void handleOnUnderSwipeableViewButtonClicked(View v) {
        int position = mRecyclerView.getChildAdapterPosition(v);
        if (position != RecyclerView.NO_POSITION) {
            ((DoubleUnderSwipeableExampleActivity) getActivity()).onItemButtonClicked(position);
        }
    }
    ...
    public MyAbstractDataProvider getDataProvider() {
        return ((DoubleUnderSwipeableExampleActivity) getActivity()).getDataProvider();
    }
