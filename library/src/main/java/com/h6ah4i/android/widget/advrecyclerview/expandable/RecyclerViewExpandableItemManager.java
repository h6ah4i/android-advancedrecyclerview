...
/**
 * Provides item expansion operation for {@link androidx.appcompat.widget.RecyclerView}
 */
public class RecyclerViewExpandableItemManager implements ExpandableItemConstants {
    ...
    /**
     * Packed position version of {@link androidx.appcompat.widget.RecyclerView#NO_POSITION}
     */
     ...
     * @return The child position portion of the packed position. If this does not contain a child, returns {@link androidx.appcompat.widget.RecyclerView#NO_POSITION}.
     */
     ...
     * @return THe group position of the packed position. If this does not contain a group, returns {@link androidx.appcompat.widget.RecyclerView#NO_POSITION}.
     */
     ...
     *
     * @param rawViewType raw view type value (return value of {@link androidx.appcompat.widget.RecyclerView.ViewHolder#getItemViewType()})
     ...
     *
     * @param rawId raw item ID value (return value of {@link androidx.appcompat.widget.RecyclerView.ViewHolder#getItemId()})
     * @return True for the a group view type, otherwise false
     */
